...
// import { Const } from "./wrapper/Const";
...
//                 <Layout>
//                     {/* <Header onLoginOff={this.handleLoginOff} messages={this.state.msgRows} onMenuChange={this.handleMenuChange} /> */}
...
//     // private handleMenuChange = (reg: string) => {
//     //     // return <Redirect to={{ pathname: "/out/login" }} />;
