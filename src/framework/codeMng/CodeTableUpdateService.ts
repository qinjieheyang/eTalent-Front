...
// // import { ActionHandlerTemplate } from "../action/ActionHandlerTemplate";
...
//         // 浏览器缓存恢复
//         let dto: { timestamp: number; items: [] } = UtilBrowserStorage.sessionGet(STORE_KEY);
//         if (!dto) {
...
//             this.ResetCodeMapCodeTable(dto.items);
//             UtilBrowserStorage.sessionSave(STORE_KEY, dto);
//             this.dispatchAction();
//         } catch (e) {
//             notification.warn({
...
//             codeTables.push(val);
//         });
//         // const ac = new ActionHandlerTemplate("codeTables", codeTables);
